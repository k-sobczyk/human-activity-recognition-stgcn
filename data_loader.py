...
def create_sequences(
    ...
    """Creates sequences from landmark data using sliding window approach."""
    sequences = []
    labels = []
    ...
    feature_cols = [col for col in df.columns
                    if col not in ['frame_number', 'exercise']]
...
def prepare_dataloaders(
    ...
    """Prepares train and test DataLoaders for model training."""
